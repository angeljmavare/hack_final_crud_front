...
function App() {
  ...
  const add = () => {
    ...
    Axios.post("http://3.90.107.7:3000/hack_final_crud_back/index.js/create", {
      nombre: nombre,
      edad: edad,
      correo: correo,
    }).then(() => {
  ...
  const update = () => {
    Axios.put("http://db-crud-usuarios-final.cj2cywk4i2hh.us-east-1.rds.amazonaws.com:3000/update", {
      id: id,
      nombre: nombre,
      edad: edad,
      correo: correo,
  ...
  const borrarUsuario = (val) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        Axios.delete(`http://db-crud-usuarios-final.cj2cywk4i2hh.us-east-1.rds.amazonaws.com:3000/delete/${val.id}`).then(() => {
          Swal.fire({
  ...
  const getUsuarios = () => {
    Axios.get("http://db-crud-usuarios-final.cj2cywk4i2hh.us-east-1.rds.amazonaws.com:3000/usuarios").then((response) => {
